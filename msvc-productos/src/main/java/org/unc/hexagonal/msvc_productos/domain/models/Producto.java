package org.unc.hexagonal.msvc_productos.domain.models;
...
public class Producto {
    ...
    public void actualizarEstado(EstadoProducto nuevo) {
        this.estado = Objects.requireNonNull(nuevo, "Estado requerido");
    }
